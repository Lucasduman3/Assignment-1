...
class Blog_ATS(unittest.TestCase):
    ...
    def test_blog(self):
        ...
        assert "Logged In"
        time.sleep(1)
        driver.find_element_by_xpath('/html/body/div[2]/div/div/div[5]/h1/a').click()
        time.sleep(1)
